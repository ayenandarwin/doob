...
class BronzeScreen extends StatefulWidget {
  const BronzeScreen({super.key});

  @override
  State<BronzeScreen> createState() => _BronzeScreenState();
}

class _BronzeScreenState extends State<BronzeScreen> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Image.asset('assets/Image/BronzeMember.png'),
              ],
            ),
          ),
        ],
