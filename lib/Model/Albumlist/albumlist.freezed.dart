...
abstract class $AlbumListCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? status, List<Album>? data});
}
...
class _$AlbumListImpl implements _AlbumList {
  const _$AlbumListImpl(this.status, final List<Album>? data) : _data = data;
  ...
  @override
  String toString() {
    return 'AlbumList(status: $status, data: $data)';
  }
...
abstract class _AlbumList implements AlbumList {
  const factory _AlbumList(final bool? status, final List<Album>? data) =
      _$AlbumListImpl;
