...
class _$SongsImpl implements _Songs {
  ...
  @override
  String toString() {
    return 'Songs(id: $id, name: $name, cover_photo: $cover_photo, audio: $audio, run_time: $run_time, lyric: $lyric, album_id: $album_id, owner_id: $owner_id, status: $status, type: $type, mtv: $mtv, reject_reason: $reject_reason)';
  }
...
abstract class _Songs implements Songs {
  const factory _Songs(
      ...
      final String? type,
      final String? mtv,
      final String? reject_reason) = _$SongsImpl;
