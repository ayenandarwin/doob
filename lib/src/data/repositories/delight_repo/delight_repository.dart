...
abstract class DelightRepository {
  Future<dynamic> fetchMusics(String endPoint, {Map<String, dynamic>? params, Object? body});
}

class DelightRepositoryImpl implements DelightRepository {
  late final HttpService _httpService;

  DelightRepositoryImpl(this._httpService);
...
final delightRepositoryProvider = Provider<DelightRepositoryImpl>((ref) {
  final httpService = ref.watch(httpProvider);

  return DelightRepositoryImpl(httpService);
});
